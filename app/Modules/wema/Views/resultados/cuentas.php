...
<?= $this->section('content') ?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-8">
            <h1>Resultados: Navegar por cuentas</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
              ...
              <div class="card-body">
                ...
                <table id="tabla_cuentas" class="table table-bordered table-striped">
                  ...
                  <?php foreach ($listadoEmpresas as $key => $empresa){
                    ...
                    (strcmp($empresa->eliminado, 'true') == 0) ? $check= 'filaEliminada' : $check = '';
                    echo '<tr class="centrar '.$check.'" data-json=\''.json_encode($empresa).'\'>';
                    echo'<td>
                            <div class="btn-group"> 
                              <i class="fa fa-search" style="cursor: pointer;margin: 3px;" title="Ver Detalles" onclick="verCuenta(this);"></i>
                              <a style="color:black" href="'. site_url('resultado/clientes/'.$empresa->empr_id) .'"><i class="fa fa-users" style="cursor: pointer;margin: 3px;" title="Ver Clientes"></i></a>
                            </div>
                          </td>
    ...
    <div class="modal fade right" id="nueva_cuenta" aria-modal="true" role="dialog">
        <div class="modal-dialog modal-xl">
          ...
          <div class="modal-header">
                ...
                <label class="switch">
                <div id="btn-habilitarCuenta" class="bootstrap-switch-container" style="width: 126px;" hidden>
...
function verCuenta(e){
    ...
    var tr = $(e).closest('tr');
    var json = $(tr).data('json');
    $('#btn-clientes').attr('href','<?=  site_url('') ?>resultado/clientes/'+json.empr_id);
